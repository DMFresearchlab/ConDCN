...
def stim_config(ifi):
    ...
    # Stimuli parameters
    stim['size_stim'] = 17 # degs # este es el lado del cuadrado del grating
...
def draw_basic(win, stim): # creates a dictionary with basic stimulus features
    ...
    basic_stim['feedback1'] = visual.Circle(win=win,units="deg", lineWidth = 20,radius=1, edges=64, color = [0.5, 0.5, 0.5], pos = [-4, -11])
    basic_stim['feedback2'] = visual.Circle(win=win,units="deg", lineWidth = 20,radius=1, edges=64, color = [0.5, 0.5, 0.5], pos = [0, -11])
    basic_stim['feedback3'] = visual.Circle(win=win,units="deg", lineWidth = 20,radius=1, edges=64, color = [0.5, 0.5, 0.5], pos = [4, -11])
    return basic_stim
